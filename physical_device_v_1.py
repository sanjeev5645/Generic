        ...
        try:
            ...
            for workload in self.workloads:
                ...
                if REUSE_TABLES_KEY in workload:
                    ...
                    if ((workload[COMMAND_KEY]) == 'show system'):
                        command_result = Path('/Users/sanjeevsathish/Desktop/Sanjeev/vRNI/UANI/network-insight-sdk-generic-datasources/Alcatel/SWITCH1/show_version').read_text()
                        print('show system')
                        print(command_result)
                    elif((workload[COMMAND_KEY]) == 'show vrf'):
                        command_result = Path('/Users/sanjeevsathish/Desktop/Sanjeev/vRNI/UANI/network-insight-sdk-generic-datasources/Alcatel/VRF1/vrf1').read_text()
                        print('show vrf')
                        print(command_result)
                    elif ((workload[COMMAND_KEY]) == 'show interfaces'):
                        command_result = Path('/Users/sanjeevsathish/Desktop/Sanjeev/vRNI/UANI/network-insight-sdk-generic-datasources/Alcatel/SWITCH_PORT1/port1').read_text()
                        print('show interface')
                        print(command_result)
                    elif ((workload[COMMAND_KEY]) == 'show ip interface'):
                        command_result = Path('/Users/sanjeevsathish/Desktop/Sanjeev/vRNI/UANI/network-insight-sdk-generic-datasources/Alcatel/ROUTER_INTERFACE1/port').read_text()
                        print('show ip interface')
                        print(command_result)
                    elif((workload[COMMAND_KEY]) == 'show ip routes'):
                        command_result = Path('/Users/sanjeevsathish/Desktop/Sanjeev/vRNI/UANI/network-insight-sdk-generic-datasources/Alcatel/ROUTES1/routes1').read_text()
                        print('show route')
                        print(command_result)
                    else:
                        print("check WORKLOAD in yml")
